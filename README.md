...
### About the Developer
Aryan Khokhar is a Marketing Analyst with nearly 4 years of experience in optimizing campaign performance and customer engagement. This project reflects a commitment to building scalable data architectures that bridge the gap between raw data engineering and actionable marketing insights. By leveraging SQL and the Medallion architecture, this repository provides a foundation for advanced audience segmentation and performance tracking.